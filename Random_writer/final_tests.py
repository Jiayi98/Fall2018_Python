...
class RandomWriterTests(unittest.TestCase):
    ...
    implementation is not particularly optimized. Just make sure you
    are not interating any sequences repeatedly when you don't need to
    or anything like that. (HINT: Use dicts when you need to perform
    lookups)
    """
